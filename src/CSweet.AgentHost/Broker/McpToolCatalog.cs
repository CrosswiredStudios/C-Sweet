...
public sealed class McpToolCatalog(IEnumerable<IPlatformCapabilityHandler> handlers)
{
    ...
    [
        ...
        Write(WorkItemActions.Create, "create_work_item",
            "Create a typed Initiative, Epic, Story, Task, or Bug on a granted board. Story, Task, and Bug items require a planning or delivery specification."),
    ...
    private static JsonElement InputFor(string capability) => capability switch
    {
        ...
        CommunicationCapabilities.CoordinationStartWork => Schema("""
            {"type":"object","required":["targetOrganizationUserId","boardId","itemId","sprintExecutionId","stageExecutionId","assignmentRevision","subject","objective","successCriteria","initialMessage","idempotencyKey"],"properties":{"targetOrganizationUserId":{"type":"string","format":"uuid"},"boardId":{"type":"string","format":"uuid"},"itemId":{"type":"string","format":"uuid"},"sprintExecutionId":{"type":"string","format":"uuid"},"stageExecutionId":{"type":"string","format":"uuid"},"assignmentRevision":{"type":"integer","minimum":1},"subject":{"type":"string","minLength":1,"maxLength":256},"objective":{"type":"string","minLength":1,"maxLength":4096},"successCriteria":{"type":"array","minItems":1,"maxItems":20,"items":{"type":"string","minLength":1,"maxLength":2048}},"initialMessage":{"type":"string","minLength":1,"maxLength":32768},"idempotencyKey":{"type":"string","minLength":1,"maxLength":160}},"additionalProperties":false}
            """),
        ...
        WorkItemActions.Create => Schema("""
            {"type":"object","required":["boardId","title","kind","priority","idempotencyKey"],"properties":{"boardId":{"type":"string","format":"uuid"},"title":{"type":"string","minLength":1,"maxLength":512},"description":{"type":["string","null"],"maxLength":8192},"kind":{"type":"string","enum":["Initiative","Epic","Story","Task","Bug"]},"priority":{"type":"string","enum":["Low","Medium","High","Critical"]},"columnId":{"type":["string","null"],"format":"uuid"},"parentItemId":{"type":["string","null"],"format":"uuid"},"dueDate":{"type":["string","null"],"format":"date-time"},"planning":{"type":["object","null"],"required":["requirements","acceptanceCriteria"],"properties":{"requirements":{"type":"array","minItems":1,"maxItems":200,"items":{"type":"string","minLength":1,"maxLength":4096}},"acceptanceCriteria":{"type":"array","minItems":1,"maxItems":200,"items":{"type":"string","minLength":1,"maxLength":4096}},"constraints":{"type":["array","null"],"maxItems":200,"items":{"type":"string","minLength":1,"maxLength":4096}},"dependencyItemIds":{"type":"array","maxItems":500,"items":{"type":"string","format":"uuid"}},"architectureArtifactDigest":{"type":["string","null"],"minLength":64,"maxLength":128},"delegationRecommendations":{"type":"array","maxItems":100,"items":{"type":"object","required":["stageKey","requiredRoleKey","requiredCapabilityKeys","specialistRequired","rationale"],"properties":{"stageKey":{"type":"string","minLength":1,"maxLength":160},"requiredRoleKey":{"type":"string","minLength":1,"maxLength":160},"requiredCapabilityKeys":{"type":"array","maxItems":100,"items":{"type":"string","minLength":1,"maxLength":256}},"parallelizationGroup":{"type":["string","null"],"maxLength":160},"specialistRequired":{"type":"boolean"},"rationale":{"type":"string","minLength":1,"maxLength":2048}},"additionalProperties":false}}},"additionalProperties":false},"delivery":{"type":["object","null"],"required":["repositoryId","requirements","acceptanceCriteria"],"properties":{"repositoryId":{"type":"string","format":"uuid"},"baseBranch":{"type":"string","minLength":1,"maxLength":512},"requirements":{"type":"array","minItems":1,"maxItems":200,"items":{"type":"string","minLength":1,"maxLength":4096}},"acceptanceCriteria":{"type":"array","minItems":1,"maxItems":200,"items":{"type":"string","minLength":1,"maxLength":4096}},"constraints":{"type":["array","null"],"maxItems":200,"items":{"type":"string","minLength":1,"maxLength":4096}},"qualityGateColumnId":{"type":["string","null"],"format":"uuid"},"dependencyItemIds":{"type":"array","maxItems":500,"items":{"type":"string","format":"uuid"}},"isQaTrackingDefect":{"type":"boolean"}},"additionalProperties":false},"accountableOrganizationUserId":{"type":["string","null"],"format":"uuid"},"stageAssignments":{"type":"array","maxItems":100,"items":{"type":"object","required":["stageKey","principalKind"],"properties":{"stageKey":{"type":"string","minLength":1,"maxLength":160},"principalKind":{"type":"string","enum":["Human","AgentInstallation","BoardManager","PlatformAction"]},"organizationUserId":{"type":["string","null"],"format":"uuid"},"agentInstallationId":{"type":["string","null"],"format":"uuid"},"platformAction":{"type":["string","null"],"maxLength":160}},"additionalProperties":false}},"mentions":{"type":"array","maxItems":100,"items":{"type":"object","required":["organizationUserId","field","offset","length"],"properties":{"organizationUserId":{"type":"string","format":"uuid"},"field":{"type":"string","enum":["Title","Description"]},"offset":{"type":"integer","minimum":0},"length":{"type":"integer","minimum":1}},"additionalProperties":false}},"idempotencyKey":{"type":"string","minLength":1,"maxLength":160}},"additionalProperties":false}
            """),
