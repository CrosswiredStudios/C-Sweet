...
public static class DependencyInjection
{
    public static IHostApplicationBuilder AddCSweetInfrastructure(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeDefaultsService>();
        builder.Services.AddScoped<CSweet.Application.Compute.IComputeDefaults>(sp => sp.GetRequiredService<CSweet.Infrastructure.Compute.ComputeDefaultsService>());
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeRegistry>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeGrantAdministration>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputePublicationAccess>();
        builder.Services.AddScoped<CSweet.Application.Compute.IComputeNodeTrust>(sp => sp.GetRequiredService<CSweet.Infrastructure.Compute.ComputeRegistry>());
        builder.Services.AddScoped<CSweet.Application.Compute.IComputeTemplateCatalog>(sp => sp.GetRequiredService<CSweet.Infrastructure.Compute.ComputeRegistry>());
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeBroker>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeFailedProvisionCleanup>();
        builder.Services.AddScoped<CSweet.Application.Compute.IComputeBroker>(sp => sp.GetRequiredService<CSweet.Infrastructure.Compute.ComputeBroker>());
        builder.Services.Configure<CSweet.Infrastructure.Compute.ComputeSigningOptions>(options => options.AutoProvisionDevelopmentCertificate = builder.Environment.IsDevelopment());
        builder.Services.Configure<CSweet.Infrastructure.Compute.ComputeSigningOptions>(builder.Configuration.GetSection(CSweet.Infrastructure.Compute.ComputeSigningOptions.SectionName));
        builder.Services.AddSingleton<CSweet.Application.Compute.IComputeDispatchSigner, CSweet.Infrastructure.Compute.ComputeDispatchSigner>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeDispatchAuthorizer>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeProviderWorkRequestVerifier>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeProviderWorkService>();
        builder.Services.AddScoped<CSweet.Infrastructure.Compute.ComputeProviderResultVerifier>();
        ...
        if (!builder.Environment.IsEnvironment("Testing"))
        {
            ...
            builder.Services.AddHostedService<WorkExecutionRecoveryWorker>();
        }
